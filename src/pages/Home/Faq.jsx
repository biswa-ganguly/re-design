  ...
  return (
    <>    <div className="h-[80vh] bg-[#6735EA]">
      <div className="flex flex-row justify-between">
        <div className="flex justify-start items-start text-[#FECE02] font-archivo text-[80px] p-8 font-semibold">
          FAQs
        </div>

        <div className="flex flex-col items-center p-12">
          <div className="flex items-center -mb-8">
            <img src="Arrow.svg" alt="arrow" className="w-36 fill-white -rotate-[160deg] mr-4" />
            <img src="/questionmark.svg" alt="questionmark" className="w-20 h-20 hover:rotate-180 duration-300" />
          </div>

          <div className="text-white font-architects text-[26px] mt-4 mr-52">
            Nothing Special
          </div>
        </div>
      </div>
