...
function Founders() {
  ...
  return (
    <div className=" flex flex-col gap-24 lg:gap-0 items-center lg:flex-row justify-around my-20 px-10 relative">
      <div
      ...
      >
        ...
        >
          ...
          creativity. We bring a clean slate entwined with a passionate approach
          to everything we do. We're here to build with you and that is what
