        ...
        {faqItems.map((item, index) => (
          <div key={index} className="border-b border-gray-700 mb-4">
            <button
              ...
              className={`w-full flex justify-between items-center p-4 bg-white text-black shadow-md ${
            ...
            >
              ...
              <span className="text-lg font-semibold">
                {itIsOpen === index ? (
                  <IoIosArrowDown className="h-5 w-5 duration-500" />
                ) : (
                  <IoIosArrowForward className="h-5 w-5 duration-500" />
                )}
              </span>
            </button>
            ...
            <div
              className={`overflow-hidden transition-all duration-500 ${
                itIsOpen === index ? 'max-h-[200px] opacity-100' : 'max-h-0 opacity-0'
              }`}
            >
