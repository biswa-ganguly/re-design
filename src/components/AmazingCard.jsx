const AmazingCard = ({ title, description, tags, image }) => {
  return (
    <div className="md:w-[550px] md:h-[500px] lg:w-[620px] lg:h-[560px] w-[380px] h-[500px] rounded-[32px] border-[4px] border-[#6735EA] flex flex-col gap-5 py-4 px-4 items-center">
      <div className="rounded-[16px] transform transition-transform duration-500 hover:scale-95 hover:rotate-2 hover:translate-x-1 hover:translate-y-1">
        {image ? (
          <img
            src={image}
            alt={title}
            className="md:w-[520px] md:h-[270px] lg:w-[588px] lg:h-[320px] w-[350px] h-[500px] rounded-[16px]"
          />
        ) : (
          <div className="md:w-[520px] md:h-[270px] lg:w-[588px] lg:h-[320px] w-[350px] h-[500px] rounded-[16px]"></div>
        )}
      </div>
